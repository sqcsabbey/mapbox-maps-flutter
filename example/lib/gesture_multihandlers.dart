...
class GestureMultihandlersPage extends ExamplePage {
  GestureMultihandlersPage()
      : super(const Icon(Icons.map), 'Additional gesture handling');

  @override
  Widget build(BuildContext context) {
    return const GestureMultihandlersMap();
  }
}

class GestureMultihandlersMap extends StatefulWidget {
  const GestureMultihandlersMap();

  @override
  State createState() => GestureMultihandlersMapState();
}

class GestureMultihandlersMapState extends State<GestureMultihandlersMap> {
  MapboxMap? mapboxMap;
  var isLight = true;
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        ...
        body: Stack(children: [
          ...
          TransparentPointer(
              child: RotatePanZoomHandler(
                  onPan: () => print("handle manual pan"),
                  onZoom: () => print("handle manual zoom"),
                  onRotate: () => print("handle manual rotate"),
